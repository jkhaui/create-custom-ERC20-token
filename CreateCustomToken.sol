...
contract CustomToken is MintableToken, BurnableToken {
    ...
    string public constant name = "YourTokenNameHere" /* Replace with your token name */;
    string public constant symbol = "TKN" /* Your symbol which should be 3-5 letters */;
    uint8 public constant decimals = 18 /* Highly recommended to leave decimals to 18 */;
